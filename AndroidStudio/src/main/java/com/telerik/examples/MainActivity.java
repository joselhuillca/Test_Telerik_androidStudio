...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks,
    ...
    private List<Test_RadlistAdapter> getListOfCities() {
        List<Test_RadlistAdapter> cities = new ArrayList<>();
        cities.add(new Test_RadlistAdapter("London", "United Kingdom"));
        cities.add(new Test_RadlistAdapter("Berlin", "Germany"));
        cities.add(new Test_RadlistAdapter("Madrid", "Spain"));
        cities.add(new Test_RadlistAdapter("Rome", "Italy"));
        cities.add(new Test_RadlistAdapter("Paris", "France"));
        cities.add(new Test_RadlistAdapter("Hamburg", "Germany"));
        cities.add(new Test_RadlistAdapter("Barcelona", "Spain"));
        cities.add(new Test_RadlistAdapter("Munich", "Germany"));
        cities.add(new Test_RadlistAdapter("Milan", "Italy"));
        cities.add(new Test_RadlistAdapter("Cologne", "Germany"));
        return cities;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_TestRadlist cityAdapter = new Adapter_TestRadlist(getListOfCities());
